...
public class initDB {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = craeteMember("userA", "서울", "1", "1111");
            em.persist(member);
        ...
        public void dbInit2() {
            Member member = craeteMember("userB", "대구", "2", "2222");
            em.persist(member);
        ...
        private Member craeteMember(String name, String city, String street, String s2) {
